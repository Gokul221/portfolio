  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 my-10 gap-10 dark:text-black"
      >
        {workData
      ...
      {!showMore && (
        <motion.button
          ...
          className="w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-auto hover:bg-lightHover duration-300 dark:text-white dark:border-white dark:hover:bg-darkHover"
        >
          Show more
          <Image
            src={
